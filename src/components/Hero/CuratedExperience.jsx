...
const CuratedExperience = () => {
  const images = [
    { src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxljCiU3pRUXpw-39aklTNk7BDV3G9Dn7ocw&s", name: "Picture One" },
  ...
  return (
    <div className="main-container w-full md:px-6 py-10 ">
      <div className="header ">
        <h1>Welcome to the Gallery</h1>
        <p>Explore the collection by hovering over the cards!</p>
      </div>
      <div className="w-full h-full flex justify-center flex-col items-center px-3  max-w-[120em] py-10 rounded-xl bg-[#2C2C2C]">
        <h1 className="text-3xl  text-[#FFFFF0] pb-5">Rooms</h1>
        <div className="grid grid-cols-2 lg:grid-cols-3  gap-6 w-full  md:px-5 lg:px-10 ">
          {images.map((image, index) => (
            <div key={index} className="card min-h-[15em] md:min-h-[320px] ">
              <div className="card-front rounded-xl">
                <img src={image.src} alt={image.name} className="shadow-2xl" />
              </div>
      ...
      <div className="w-full h-full flex justify-center mt-10 flex-col items-center px-3   py-10 rounded-xl bg-[#2C2C2C]">
        <h1 className="text-3xl text-[#FFFFF0] pb-5">Rooms</h1>
        <div className="grid md:grid-cols-2 lg:grid-cols-4  gap-6 w-full md:px-5 lg:px-10">
          {images2.map((image, index) => (
            <div
              key={index}
              className={`card min-h-[15em] md:min-h-[320px] ${
                index === 0
            ...
            >
              ...
              <div
                className={`${
                  index !== 0 ? "card-back " : "hidden"
                } rounded-xl flex items-center justify-center h-full `}
              >
                <h2>{image.name}</h2>
              </div>
            </div>
      ...
      <div className="w-full h-full flex justify-center flex-col items-center mt-10  px-3 max-w-[120em] py-10 rounded-xl bg-[#2C2C2C]">
        <h1 className="text-3xl text-[#FFFFF0] pb-5">Rooms</h1>
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-6 w-full  md:px-5 lg:px-10 ">
          {images.map((image, index) => (
            <div key={index} className="card min-h-[15em] md:min-h-[320px] ">
      ...
      <div className="w-full h-full flex justify-center mt-10 flex-col items-center px-3  bg-[#2C2C2C] py-10 rounded-xl0">
        <h1 className="text-3xl text-[#FFFFF0] pb-5">Rooms</h1>
        <div className="grid md:grid-cols-2 lg:grid-cols-4  gap-6 w-full  md:px-5 lg:px-10 ">
          {images2.map((image, index) => (
            <div
